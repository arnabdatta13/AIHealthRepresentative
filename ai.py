    ...
    for tool_call in tool_calls:
        ...
        if tool_name == 'save_treatment_tool':
            ...
            if appointment_id in appointment_database:
                ...
                print(f"Your treatment has been changed to {new_treatment}.Now that we've identified your treatment, would you like to book an appointment for this treatment?")
                messages.append({"role": "assistant", "content": f"Your treatment has been changed to {new_treatment}.Now that we've identified your treatment, would you like to book an appointment for this treatment?"})
    return messages
            ...
            if tool_call.function.name == 'send_query_to_agents':
                ...
                for agent in agents:
                    if agent == "Treatment Agent":
                        ...
                        handle_treatment_agent(query, conversation_messages)
            ...
            if tool_call.function.name == 'appointment_tool':
                ...
                for agent in agents:
                    if agent == "Treatment Agent":
                        ...
                        handle_appointment_management_agent(query,conversation_messages)
            ...
            if tool_call.function.name == 'save_treatment_tool' or tool_call.function.name == 'change_treatment_tool':
                ...
                for agent in agents:
                    if agent == "appointment booking assistant":
                        ...
                        handle_appointment_booking_agent(query, conversation_messages)
                        return  # Exit after routing
...
while True:
    ...
    if current_agent == "TrigeAgent":
        ...
        handle_appointment_booking_agent(user_query, conversation_messages)
    elif current_agent == "TreatmentAgent":
        handle_treatment_agent(user_query, conversation_messages)
    elif current_agent == "AppointmentManagementAgent":
        handle_appointment_management_agent(user_query,conversation_messages)